...
HRESULT CEnderEye::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(CProtoMgr::GetInstance()->Clone_Prototype(L"Proto_EnderEyeTexture"));
	...
	pComponent = m_pColliderCom = CCollider::Create(m_pGraphicDev, _vec3{ 3.0f, 3.0f, 3.0f }, _vec3{ 0.f, 0.f, 0.f });
